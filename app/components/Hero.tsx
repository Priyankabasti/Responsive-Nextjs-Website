    ...
    <div className="pt-4 lg:pt-10">
      <div className="px-[20px] lg:px-[280px]">
        ...
        <div className="flex w-full pt-8 justify-center gap-x-6">
          <button className="bg-indigo-700 w-1/2 py-4 px-8 text-white rounded-[4px] lg:w-fit">
            Try it for free
          </button>
          <button className="w-1/2 text-indigo-700 flex items-center justify-center gap-x-4 lg:w-fit">
            View pricing
            <span className="">
      ...
      <div className="relative flex h-full w-full justify-center">
        ...
        <div className="absolute bottom-5 flex w-full flex-col items-center">
          ...
          <div className="flex w-full flex-col items-center lg:container lg:flex-row lg:justify-between lg:px-20">
            ...
            <div className="grid grid-cols-3 items-center justify-center justify-itens-center px-[20px] align-middle lg:grid-cols-5">
              <Image src={Google} alt="" />
              <Image src={Slack} alt="Learn More" />
              <Image src={Truspilot} alt="Learn More" />
              <Image src={Cnn} alt="Learn More" />
              <Image src={Cluth} alt="Learn More" />
